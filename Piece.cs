...
public class Piece : MonoBehaviour {
    ...
    if (checkValidMove(square)) {
        ...
        // Optional: Add any additional logic you want to trigger after a successful move
        // e.g., check for checkmate or update the UI
    } else {
        // Optional: Debug log if the move isn't valid
        Debug.Log("Invalid move attempted for: " + piece_name);
    }
